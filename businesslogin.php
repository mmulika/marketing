...
if(isset($_POST['Done'])){
  ...
  $sql = "SELECT  `Business_Number`, `Business_Name` FROM `companyreg_tbl` WHERE Business_Number ='$Business_Number' AND  Business_Name = '$Business_Name'";
...
<div class="container-fluid">
  ...
  <form method="POST" class="form-group">
    <h3><u>Company Login Form</u></h3>
    <label>Business Number</label>
    <input type="text" class="form-control" name="Business_Number" required="" placeholder="Enter Business_Number">
    <br/>
    <br/>
    <label>Business Name</label>
    <input type="text" class="form-control" name="Business_Name" required="" placeholder="Enter Business_Number">
    <br/>
    <br/>
    <input type="submit" class="btn btn-outline-secondary btn-block"  name="Done" self ><br>
...
<p class="text-center">Haven't Registered company with us?<a href="companyreg.php">Register here</a></p>
...
if(isset($_POST['Done'])){
  ...
  $sql = "SELECT  `Business_Number` FROM `companyreg_tbl` WHERE Business_Number ='$Business_Number'";
