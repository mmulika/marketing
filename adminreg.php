...
if (isset($_POST['Done'])) {
  ...
  if (!$con) {
    ...
    $sql ="INSERT INTO`admin_tbl`(`Username`, `Password`) VALUES ('$Username','$Password')";


      if ($con->query($sql)===TRUE) {
        echo"Admin registered succefully";
      }
      else{
       echo "Error";
      }
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav nav-flex-icons">
          ...
          <li class="nav-item">
            <a href="allproducts.php" class="nav-link border border-light rounded"
              target="_blank">
